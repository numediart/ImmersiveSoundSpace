...
public class TrackerPrefabAndSerial
{
    ...
    public string trackerName;  // optional, name to give to the object in hierachy
...
public class TrackersManagerOSC : MonoBehaviour
{
    ...
    private string GetTrackerName(string trackerSerial)
    {
        foreach (TrackerPrefabAndSerial track in trackersSerialAndPrefab)
        {
            if (track.serial == trackerSerial)
            {
                if(string.IsNullOrEmpty(track.trackerName))
                {
                    return trackerSerial;
                }
                else
                {
                    return track.trackerName;
                }
            }
        }
        return null;
    ...
    public void CreateTracker(string trackerSerial)
    {
        ...
        string gameObjectName = GetTrackerName(trackerSerial);
